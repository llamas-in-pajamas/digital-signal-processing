...
namespace ComplexUtils
{
    ...
    {
        public static DataHandler GetCustomSignal(double duration)
        {
            var signal1 = new DataHandler(2.0, duration, 0, 2.0, "Sinus", 0,0,0,16.0);
            signal1.Call();
            var signal2 = new DataHandler(1.0, duration, 0, 1.0, "Sinus", 0,0,0,16.0);
            signal2.Call();
            var signal3 = new DataHandler(5.0, duration, 0, 0.5, "Sinus", 0,0,0,16.0);
            signal3.Call();
